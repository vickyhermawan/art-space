...
export default function Title({title,description}:TitleProps){
    return (
        <>
            <Container maxW="7xl" centerContent paddingTop={{ base :"6", md:"20", lg:"40"}} paddingLeft={{ base :"7", md:"20", lg:"40"}} paddingRight={{ base :"7", md:"20", lg:"40"}} paddingBottom={{ base :"10"}}>
                <Box mt={{base:"36", md:"28", lg:"10"}}>
                    <Fade duration={500} distance="30px" fraction={0.4} bottom>
                        <Text textAlign="center" mt={{ base :"1.5"}} fontSize={{ base :"small", md:"medium", lg:"medium"}}>Vihermawan's</Text>
